...
$(SYMLINKS):
	...
	@echo "Copy: vendor/asus/a500cg/proprietary/system/lib/ditlib_a500cg/libxditk_DIT_CloverTrailPlus.so -> $(TARGET_OUT)/lib/ditlib_a500cg/libxditk_DIT_CloverTrailPlus.so"
	$(hide) cp -f "$(LOCAL_PATH)/../../vendor/asus/a500cg/proprietary/system/lib/ditlib_a500cg/libxditk_DIT_CloverTrailPlus.so" "$(TARGET_OUT)/lib/ditlib_a500cg/libxditk_DIT_CloverTrailPlus.so"
	@echo "Copy: vendor/asus/a500cg/proprietary/system/lib/ditlib_a500cg/libxditk_DIT_Manager.so -> $(TARGET_OUT)/lib/ditlib_a500cg/libxditk_DIT_Manager.so"
	$(hide) cp -f "$(LOCAL_PATH)/../../vendor/asus/a500cg/proprietary/system/lib/ditlib_a500cg/libxditk_DIT_Manager.so" "$(TARGET_OUT)/lib/ditlib_a500cg/libxditk_DIT_Manager.so"
	@echo "Copy: vendor/asus/a500cg/proprietary/system/lib/ditlib_a600cg/libxditk_DIT_CloverTrailPlus.so -> $(TARGET_OUT)/lib/ditlib_a600cg/libxditk_DIT_CloverTrailPlus.so"
	$(hide) cp -f "$(LOCAL_PATH)/../../vendor/asus/a500cg/proprietary/system/lib/ditlib_a600cg/libxditk_DIT_CloverTrailPlus.so" "$(TARGET_OUT)/lib/ditlib_a600cg/libxditk_DIT_CloverTrailPlus.so"
	@echo "Copy: vendor/asus/a500cg/proprietary/system/lib/ditlib_a600cg/libxditk_DIT_Manager.so -> $(TARGET_OUT)/lib/ditlib_a600cg/libxditk_DIT_Manager.so"
	$(hide) cp -f "$(LOCAL_PATH)/../../vendor/asus/a500cg/proprietary/system/lib/ditlib_a600cg/libxditk_DIT_Manager.so" "$(TARGET_OUT)/lib/ditlib_a600cg/libxditk_DIT_Manager.so"
